...
try:
    ...
    post_data = {'post_escaped_chars': 'abc\x02\'\"%1', 'key3': 'value3'}
    r = requests.post("http://localhost:8080/get_vars", params=payload, data=post_data)
    r.raise_for_status()
    rc = r.text != 'key2:value2,key1:value1,escaped_chars:abc\x01\'\"%1,post_escaped_chars:abc\x02\'\"%1,key3:value3,'
    if rc:
